...
const getPlatforms = () => __awaiter(void 0, void 0, void 0, function* () { return yield supabase_1.default.from("platforms").select(); });
exports.getPlatforms = getPlatforms;
const getPlatformById = (id) => __awaiter(void 0, void 0, void 0, function* () { return yield supabase_1.default.from("platforms").select().eq("id", id); });
