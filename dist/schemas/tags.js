...
exports.deleteTagsSchemaValidation = exports.updateTagsSchemaValidation = exports.createTagsSchemaValidation = void 0;
...
exports.deleteTagsSchemaValidation = (0, yup_1.object)().shape({
    id: (0, yup_1.number)().required()
});
